...
set compileFlags=-MT -Z7 -W3 -O2 -WX
...
cl %compileFlags% ..\src\UnityBuild\UnityBuild.cpp /link -subsystem:WINDOWS,5.1 %linkLibraries% /out:"dwcopy.exe"
copy dwcopy.exe C:\cmder\private\bin\
copy 7za.exe   C:\cmder\private\bin\
